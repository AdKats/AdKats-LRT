[//]: # "<latest_stable_release>2.0.9.2</latest_stable_release>"
<p>
...
<ol>
    ...
    <li>
        ...
        Download the plugin from here: https://myrcon.net/files/file/32-on-spawn-loadout-enforcer-for-infantryvehicles-adkatslrt/ 
